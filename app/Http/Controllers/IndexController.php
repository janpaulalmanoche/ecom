...
//                                ";
        ...
        return view('index')->with(compact('productsAll','categories_menu','categories','countProductsinCart'));//and passing the variable name tht gets the data of products to index page
    }
