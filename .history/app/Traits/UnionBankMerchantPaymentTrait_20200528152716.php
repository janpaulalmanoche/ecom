...
trait UnionBankMerchantPaymentTrait
{
    ...
    public function check_merchant_payment_status($sender_referrence_id){
        
        // try{
        //     $sender_referrence_id = '8kN8MUhPapM6A1IOjQhv';
        //     $url = sprintf('https://api-uat.unionbankph.com/partners/sb/merchants/v4/payments/single/%s','testtt');
        //     $response =   $this->client->request(
        //         'GET',
        //         $url,
        //         [
