...
{//opening
    ...
    public function addProduct(Request $request){
        ...
        if($request->isMethod('post')){ //
            ...
            $check_if_category_id_is_main_category = Category::find($request->category_id);
            if($check_if_category_id_is_main_category->parent_id == 0){
                return redirect()->back()->with("flash_message_error",'You need to select a Subcategory not Main Category');
            }
    ...
    foreach($sub_categories as $sub_cat){
        ...
        return view('admin.products.add_product')->with(compact(['pppin','refferenceNO','categories_dropdown','measurement_dropdown','count']));
    }
