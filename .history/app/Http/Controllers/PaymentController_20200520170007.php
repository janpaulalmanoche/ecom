...
class PaymentController extends Controller
{
    ...
    public function generate_code(){
        ...
        $url = sprintf('https://api-uat.unionbankph.com/partners/sb/customers/v1/oauth2/authorize?client_id=<REPLACE_CLIENT_ID>&response_type=<REPLACE_THIS_VALUE>&scope=<REPLACE_THIS_VALUE>&redirect_uri=<REPLACE_THIS_VALUE>&state=<REPLACE_THIS_VALUE>&type=<REPLACE_THIS_VALUE>&partnerId=<REPLACE_THIS_VALUE>')
        return redirect($url);
