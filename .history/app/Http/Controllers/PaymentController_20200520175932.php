...
class PaymentController extends Controller
{
    ...
    public function generate_code(){
        ...
        // dd($url);
        return redirect('https://api-uat.unionbankph.com/partners/sb/customers/v1/oauth2/authorize?response_type=code&client_id=faa78f59-d055-4016-ab41-a3f812f78310&redirect_uri=https://b9333c14.ngrok.io/oauth2/callback&scope=payments&type=single');
