...
class PaymentController extends Controller
{
    ...
    public function generate_code(){
        ...
        $url = sprintf('https://api-uat.unionbankph.com/partners/sb/customers/v1/oauth2/authorize?
        client_id=%s
        &response_type=%s&scope=%s&redirect_uri=%s&state=%s&type=%s&partnerId=%s',
        $this->union_app_id,"code","payments","https://b9333c14.ngrok.io/oath2/callback","STATE","single","01bbb51e-1e6c-4bd4-af9c-450957522aac");
        return redirect($url);
