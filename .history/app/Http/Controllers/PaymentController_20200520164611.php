...
class PaymentController extends Controller
{
    ...
    public function generate_code(){
        ...
        $url = sprintf('https://api-uat.unionbankph.com/partners/sb/convergent/v1/oauth2/authorize?client_id=%s&response_type=%s&scope=%s&redirect_uri=%s',
                        $this->union_app_id,"code","payments","http://127.0.0.1:8000/oath2/callback");
