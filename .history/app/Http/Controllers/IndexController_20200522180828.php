...
//display images and categories in our index file
    public function index(){
        ...
        // dd($count_cat);
        $categories_limit = Category::skip(0)->take(5)->get();
// dd($categories);
        return view('index')->with(compact('productsAll','categories','countProductsinCart','categories_limit'));//and passing the variable name tht gets the data of products to index page
    }
