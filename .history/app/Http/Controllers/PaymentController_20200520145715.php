...
class PaymentController extends Controller
{
    ...
    public function customer_generate_code_for_access_token(){
        ...
        client_id=%s&response_type=%s&scope=%s&redirect_uri=%s&state=%s&type=%s&partnerId=%s',
        $this->union_app_id,"code","payments","http://127.0.0.1:8000/callback","testSTATEeee","single",$paymaya_partner_id);
