...
//        }
    ...
    public function deleteCartProduct($id = null){
        ...
        return redirect('/select-payment')->with('flash_message_success','Product has beem remove from the cart');
...
//            DB::table('products')->where('id',$getproductid)->decrement('stock',$quantityy);
            return redirect('/select-payment')->with('flash_message_success','Product quantity has updated');
            ...
            return redirect('/select-payment')->with('flash_message_error','Required Product Quantity is not available');
        }
    }
