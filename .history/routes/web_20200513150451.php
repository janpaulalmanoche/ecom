...
Route::group(['middleware' => ['resellerlogin']], function () {

    Route::resource('/reseller/dashboard', 'ResellerDashBoardController');
    Route::resource('/reseller/products', 'ResellerDashBoardController');
});
