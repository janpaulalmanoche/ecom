...
//for admin login
Route::get('/admin','AdminController@login');//match for FORMS
Route::post('boi','Auth\LoginController@login')->name('boi');
//for adminlogout
...
Route::match(['get','post'],'/check-email-register','UsersController@CheckEmail');
        ...
        //admin part
                        //adminlogin is found in kernep.php where we put our middleware file
