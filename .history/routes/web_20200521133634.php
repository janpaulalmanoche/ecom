...
Route::group(['middleware' => ['frontlogin']], function () {
    ...
    Route::get('generate-code','PaymentController@generate_code');

    //the generatecode request will throw a code to our callback route
    Route::get('oauth2/callback',"PaymentController@call_back_function");
    ...
    Route::get('request-online-access-token/{token}',"PaymentController@customer_request_online_access_token");
