                ...
                :height="140" :pivotY="0.5" :pivotX="0.5"
                  ...
                  <div class="dialog-content">
                    <div class="dialog-c-title"> 
                      Product : {{selected_product_information.product_name}} | Warehouse Price : {{selected_product_information.price}}
                      </div>
                    <div class="dialog-c-text">
                      * Resell Price <input type="number" style="width:78%" v-model="product_field_price">
                    </div>
                  </div>
    ...
    save() {
      axios
        .post("/api/reseller/products", {
          product_id: selected_product_information.id,
          user_id: this.user,
          reseller_price: this.product_field_price
        })
        .then(r => {
          Swal.fire(
            "Good job!",
