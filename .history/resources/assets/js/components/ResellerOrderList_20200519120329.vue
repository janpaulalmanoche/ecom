        ...
        <div class="span12">
          <div class="widget-box">
            <div class="widget-title">
              ...
              <h5>Date Ordered  <span style="padding:2px 5px;background-color:red;color:white">{{date_now}} </span>
              
              </h5>
              <input type="date" class="form-control" style="height:28px" v-model="inpuinput_datet_date" @change="axios_request">
