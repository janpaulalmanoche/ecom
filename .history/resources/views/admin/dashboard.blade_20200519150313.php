@extends('layouts.adminLayout.admin_design_js')
@section('content')
            ...
            <div class="widget-box">
                ...
                <div class="widget-content" >
                    <div class="row-fluid">
                        ...
                        <div class="span3">
                            <ul class="site-stats">
                                <li class="bg_lh"><a href="#"><i class="icon-user"></i> <strong>{{$countUsers+1}}</strong> <small>Total Users</small></a></li>
                                ...
                                <li class="bg_lh"><a href="#"><i class="icon-tag"></i> <strong>{{$Totalorders}}</strong> <small>Total Orders</small></a></li>
