                        ...
                        @foreach($userCart as $cart)
                            ...
                            <tr>
                                <td class="cart_product">
                                    <a href=""><img style="width:100px;" src="{{asset('images/backend_images/products/small/'.$carts->product()s->first()->image)}}" alt=""></a>
                                </td>
                                ...
                                <td class="cart_total">
                                    <p class="cart_total_price">P{{$carts->price*$cart->quantity}}</p>
