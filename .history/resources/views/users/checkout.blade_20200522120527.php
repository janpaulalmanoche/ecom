                        ...
                        <div class="bill-to">
                            ...
                            <div class="signup-form"x>
                                ...
                                <form id="accountForm" name="accountForm" action="{{url('/checkout')}}" method="post" >{{csrf_field()}}
                                    ...
                                    City<input id="name"  style="width:320px;"name="city" type="text" placeholder="Last Name" value="{{$user_details->city}}">
                                    Baranggay<input id="name"  style="width:320px;"name="baranggay" type="text" placeholder="Last Name" value="{{$user_details->baranggay}}">
                                    Street<input id="name"  style="width:320px;"name="street" type="text" placeholder="Last Name" value="{{$user_details->street}}">
