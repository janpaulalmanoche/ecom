                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        ...
                                        <img src="{{asset('images/backend_images/products/small/'.$product->image)}}" style="height:186.3px;width:162.32px" alt="" />
                                    </a>
                                        <!-- <h2>PHP {{$product->price}}</h2> -->
                                        <!-- price-->
                                        <p>{{$product->product_name}} {{$product->description}}</p><!-- name-->
                                        <p>{{$product->size}} {{$product->measurement}}</p><!-- name-->
                    ...
                    <div class="category-tab">
                        <div class="col-sm-12">
                            <ul class="nav nav-tabs">
                                @foreach($categories_limit as $cat)
                                <li class="active"><a href="#tshirt" data-toggle="{{$cat->name}}">{{$cat->name}}</a></li>
