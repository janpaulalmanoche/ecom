                ...
                <table class="table table-condensed">
                    ...
                    <form action="{{url('/admin/minus-quantity-stocks')}}" method="post">{{csrf_field()}}
                        ...
                        @foreach($userCart as $cart)
                            @foreach($cart->reseller_product as $prod)
                            <tr>
                                <td class="cart_product">
                                    <a href=""><img style="width:100px;" src="{{asset('images/backend_images/products/small/'.$prod->products()->first()->image)}}" alt=""></a>
                                </td>

                                <td class="cart_description">
                                    <h4><a href="">{{$prod->products()->first()->product_name}}</a></h4>
                             ...
                             {{$cart->reseller()->first()->f_name}}</span>
                                </td>
                                <td class="cart_price">
            ...
            <div class="heading">
                ...
                <div class="col-sm-6">
                    <div class="total_area">
                        ...
                        <form method="POST" action="{{url('select-payment')}}">@csrf
                        <input class="btn btn-default update" type="submit" value="Checkout with Union Bank">
