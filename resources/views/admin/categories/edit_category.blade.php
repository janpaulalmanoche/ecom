...
@section('content')
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Catgories</a> <a href="#" class="current"Edit Category</a> </div>
            <h1>Categories</h1>
        </div>
