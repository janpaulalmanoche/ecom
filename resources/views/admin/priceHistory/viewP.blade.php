    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">
                    Products</a><a href="" class="current">View Price History</a> </div>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        @if(!empty($product->image))
                                            ...
                                            <td class="center">
                                                ...
                                                <a href="{{url('/admin/view-price-history/'.$product->id) }}" class="btn btn-primary btn-mini">View Price History </a>
