    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">
                    Stocks</a><a href="" class="current">View Pending Stocks</a> </div>
            <h1>Stock</h1>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">
                                            ...
                                            @if($detail->status == 'Pending')
                                                <a href="{{url('/admin/edit-pending-past-form/'.$detail->id )}}"  class="btn btn-success btn-mini">Update</a>
                                            @endif
